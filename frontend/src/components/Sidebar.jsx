...
const Sidebar = () => {
    let linkClass = "flex gap-1 items-center text-[#71717a] font-bold mb-4 py-2 px-2";
    let activeClass = "flex gap-1 items-center text-[#71717a] font-bold mb-4 border-b-2 border-[#6366f1] rounded-b-md py-2 px-2"
  return (
    <aside className="w-[250px] bg-white h-screen rounded-tr-2xl shadow-2xl py-10 flex flex-col border-r-1 border-r-black items-center max-md:hidden">
